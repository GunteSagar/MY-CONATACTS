...
def DisplayForm():
    ...
    LFrom = Frame(display_screen, width="350",height=800,bg="maroon1")
    LFrom.pack(side=LEFT, fill=Y)

    LeftViewForm = Frame(display_screen, width=500,height=800,bg="Orange")
    LeftViewForm.pack(side=LEFT, fill=Y)

    MidViewForm = Frame(display_screen, width=600)
    MidViewForm.pack(side=RIGHT)

    lbl_text = Label(TopViewForm, text="Contact Management System", font=('verdana', 18), width=600,bg="Yellow")
    lbl_text.pack(fill=X)
  
    Label(LFrom, text="First Name  ", font=("Arial", 12),fg="#15244C",bg="maroon1").pack(side=TOP)
    Entry(LFrom,font=("Arial",10,"bold"),textvariable=fname).pack(side=TOP, padx=10, fill=X)
    Label(LFrom, text="Last Name ", font=("Arial", 12),fg="#15244C", bg="maroon1",).pack(side=TOP)
    Entry(LFrom, font=("Arial", 10, "bold"),textvariable=lname).pack(side=TOP, padx=10, fill=X)
    Label(LFrom, text="Gender ", font=("Arial", 12),fg="#15244C",bg="maroon1" ).pack(side=TOP)
    ...
    Label(LFrom, text="Address ", font=("Arial", 12),fg="#15244C",bg="maroon1").pack(side=TOP)
    Entry(LFrom, font=("Arial", 10, "bold"),textvariable=address,fg="#15244C",bg="white").pack(side=TOP, padx=10, fill=X)
    Label(LFrom, text="Contact ", font=("Arial", 12),fg="#15244C",bg="maroon1").pack(side=TOP)
